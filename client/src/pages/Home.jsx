    ...
    <div>
      ...
      <div className='flex flex-col gap-6 pt-20  px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-gray-400 text-xs sm:text-sm'>
          Housing Portal is the best place to find your next perfect place to
          live.
          <br />
      ...
      <div className='flex justify-center'>
        <img src="https://firebasestorage.googleapis.com/v0/b/react-estate-1142e.appspot.com/o/1708962672942pexels-binyamin-mellish-106399.jpg?alt=media&token=ee448b26-0bfb-4a17-ad7c-2ab7f9bdc1fd" alt="banner" 
        className='sm:h-[600px] md:w-[80%] rounded-t-full max-sm:px-2' />
      </div>
